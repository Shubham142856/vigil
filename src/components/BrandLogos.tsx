...
export const BrandLogos: React.FC = () => {
  return (
    <div className="relative z-20 pb-5 sm:pb-7 px-4 w-full flex items-center justify-center gap-6 sm:gap-10 md:gap-14 flex-wrap opacity-60 hover:opacity-85 transition-opacity select-none">
      {/* GitHub */}
