...
import { Finding } from '../../types/vigil';
...
export const CodeViewer: React.FC<CodeViewerProps> = ({
  ...
  // Scroll to selected line when finding changes
  useEffect(() => {
    ...
    <div className="flex flex-col h-full bg-black border-r border-white/10 text-white select-none">
      ...
      <div className="h-10 px-4 border-b border-white/10 bg-black flex items-center justify-between text-xs shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleCopy}
            className="p-1 rounded-full hover:bg-white/10 text-white/50 hover:text-white transition-colors flex items-center gap-1 text-[11px] cursor-pointer"
          ...
          {lines.map((lineContent, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Inline finding indicator badge tag if this is the start line */}
