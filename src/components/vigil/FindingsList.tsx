...
import { Finding, Severity, FindingSource } from '../../types/vigil';
      ...
      <div className="p-3.5 border-b border-white/10 flex flex-col gap-2.5 bg-black">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-xs text-white/50">
            ...
            <select
              ...
              className="bg-black border border-white/15 rounded-full px-2 py-0.5 text-[11px] text-white/80 focus:outline-none focus:border-white/40"
            >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-white/[0.03] border border-white/15 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-white/40"
          />
        </div>
