...
import { Finding, Feedback } from '../../types/vigil';
  ...
  return (
    <div className="flex-1 h-full bg-black flex flex-col overflow-hidden text-white select-text border-l border-white/10">
      ...
      <div className="p-4 border-b border-white/10 bg-black shrink-0 flex flex-col gap-3">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-1 border-b border-white/10 -mb-4 pt-1 overflow-x-auto text-xs font-medium">
          <button
          ...
          <div className="flex flex-col gap-4 animate-in fade-in">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-white hover:text-white font-mono p-1 rounded hover:bg-white/10 transition-colors cursor-pointer"
              >
                {copiedPatch ? (
                  <>
