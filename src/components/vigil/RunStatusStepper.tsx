...
import { ReviewStatus } from '../../types/vigil';
...
export const RunStatusStepper: React.FC<RunStatusStepperProps> = ({ status }) => {
  ...
  return (
    <div className="w-full bg-black border-b border-white/10 px-4 py-2.5 flex items-center justify-between overflow-x-auto text-xs">
