...
export const AgentInsightsSection: React.FC<AgentInsightsSectionProps> = ({
  ...
  // Microservice CWE Stacked Bar Data (15 services descending)
  const assigneeData = [
  ...
  // Repository security audit distribution table data
  const projectRows = [
  ...
  return (
    <section id="insights" className="relative z-20 w-full bg-black text-white pt-20 pb-32 px-4 sm:px-6 md:px-10 lg:px-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        {/* Top Header Grid: Headline on left, Description on right */}
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 mb-14 sm:mb-16">
          <div>
            <h2
            ...
            >
              <span className="block font-normal">Track security insights</span>
              <span className="block text-white/80 font-normal mt-1">
                in real time.
              </span>
            </h2>
          </div>
          ...
          <div className="lg:max-w-md lg:pt-2">
            ...
            >
              Monitor every code audit as it progresses, with live AST taint traces, CWE categorization, and microVM testbed verification.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row min-h-[640px]">
            ...
            <div className="w-full md:w-56 lg:w-60 border-b md:border-b-0 md:border-r border-white/10 bg-[#070709] p-4 flex flex-col justify-between select-none">
              <div className="flex flex-col gap-5">
                ...
                {/* Primary Nav with Insights Highlighted */}
            ...
            <div className="flex-1 p-5 sm:p-6 lg:p-7 bg-[#09090b] flex flex-col gap-6 overflow-x-auto">
              ...
              <div className="flex items-center gap-2 text-white">
                ...
                <span className="text-white/40 text-xs cursor-pointer hover:text-white/80">···</span>
              </div>
              ...
              {/* Lower Section: 2 Columns (Stacked Bar Chart + Projects Breakdown Table) */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 pt-1">
                {/* Column 1: Audits per service (Stacked Bar Chart) */}
                <div className="lg:col-span-5 p-4 sm:p-5 rounded-xl border border-white/10 bg-white/[0.02] flex flex-col justify-between min-h-[360px]">
                  ...
                  {/* Chart Stage with Y-Axis and Bars */}
                ...
                {/* Column 2: Repositories audited (Table Breakdown) */}
