...
export const StatefulExecutionSection: React.FC<StatefulExecutionSectionProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'schedules' | 'agents' | 'history'>('schedules');
  const [hoveredTask, setHoveredTask] = useState<string | null>(null);

  return (
    <section id="execution" className="relative z-20 w-full bg-black text-white pt-16 pb-28 px-4 sm:px-6 md:px-10 lg:px-12 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        {/* Top Header Grid: Headline on left, Description on right */}
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 mb-12 sm:mb-16">
          <div>
            <h2
            ...
            >
              <span className="block font-normal">Stateful security pipeline.</span>
              <span className="block text-white/90 font-normal mt-1">
                Continuous code verification across pull requests.
              </span>
            </h2>
          </div>
          ...
          <div className="lg:max-w-md lg:pt-2">
            ...
            >
              Vigil is the stateful runtime for automated security reviews—preserving tainted data-flow context, AST graphs, and verified patch diffs across every repository run.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row min-h-[580px]">
            ...
            <div className="w-full md:w-56 lg:w-60 border-b md:border-b-0 md:border-r border-white/10 bg-[#070709] p-4 flex flex-col justify-between select-none">
              <div className="flex flex-col gap-5">
                {/* Vigil Brand Header with Dropdown */}
            ...
            <div className="flex-1 overflow-x-auto bg-[#09090b] flex flex-col relative">
              ...
              <div className="p-6 flex flex-col gap-6 relative z-10 min-w-[700px] text-xs">
                {/* ROW 1: PR #482 · fastapi-order-gateway */}
                <div
                ...
                >
                  ...
                  <div className="relative h-9 w-full">
                    <div
                      className="absolute top-1 left-[14%] w-[72%] h-7 rounded-lg border border-white/15 bg-white/[0.04] flex items-center justify-between px-3 text-[10.5px] text-white/70 backdrop-blur-sm transition-all group-hover:border-white/30"
                    >
                      <div className="flex items-center gap-1.5">
                      ...
                      {/* Hatched/Dashed Gradient End Window */}
                ...
                >
                  ...
                  <div className="relative h-9 w-full">
                    <div
                      className="absolute top-1 left-[2%] w-[84%] h-7 rounded-lg border border-white/15 bg-white/[0.04] flex items-center justify-between px-4 text-[10.5px] text-white/70 backdrop-blur-sm transition-all group-hover:border-white/30"
                    >
                ...
                >
                  ...
                  <div className="relative h-9 w-full">
                    <div
                      className="absolute top-1 left-[18%] w-[76%] h-7 rounded-lg border border-white/15 bg-white/[0.04] flex items-center justify-between px-4 text-[10.5px] text-white/70 backdrop-blur-sm transition-all group-hover:border-white/30"
                    >
                      <div className="flex items-center gap-1.5 ml-8">
                        <span className="w-1.5 h-1.5 rounded-full bg-white/70" />
                ...
                {/* ROW 4 & 5: OWASP Benchmark Suite -> SARIF Compliance Dossier */}
                <div className="relative flex flex-col gap-4">
                  ...
                  {/* SVG Bezier Connector linking Benchmark to SARIF Export */}
                  <svg
                  ...
                  {/* SARIF Compliance Dossier (Connected Child Node) */}
                  <div
                  ...
                  >
                    ...
                    <div className="relative h-9 w-full">
                      <div
                        className="absolute top-1 left-0 w-[84%] h-7 rounded-lg border border-white/15 bg-white/[0.04] flex items-center justify-between px-6 text-[10.5px] text-white/70 backdrop-blur-sm transition-all group-hover:border-white/30"
                      >
                        <div className="flex items-center gap-1.5">
                          <span className="w-1.5 h-1.5 rounded-full bg-white/70" />
                ...
                {/* ROW 6: Secret Exfiltration Sweep */}
                <div
                  className="flex flex-col gap-1.5 group cursor-pointer"
                ...
                >
                  ...
                  <div className="relative h-9 w-full">
                    <div
                      className="absolute top-1 left-[7%] w-[58%] h-7 rounded-lg border border-white/15 bg-white/[0.04] flex items-center justify-between px-6 text-[10.5px] text-white/70 backdrop-blur-sm transition-all group-hover:border-white/30"
                    >
        ...
        <div className="mt-14 sm:mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 pt-2">
          ...
          {/* Column 2: Reason with AST context */}
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center gap-2 text-white font-medium text-[15px] sm:text-[16px]">
